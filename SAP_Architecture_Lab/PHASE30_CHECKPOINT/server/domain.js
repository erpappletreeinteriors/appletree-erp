...
function postInventoryMovement({type, materialId, qty, uom, warehouseId, projectId, sourceType, sourceId, valuationRate, actor, locationId}){
  ...
  const mv = { id:'MV-'+String(DB.inventoryMovements.length+1).padStart(6,'0'), type, materialId, qty:+qty, uom:uom||'',
    warehouseId, locationId:locationId||null, projectId:projectId||null, sourceType, sourceId, date:new Date().toISOString().slice(0,10),
...
function createMaterialIssue({projectId, materialId, qty, warehouseId, purpose, requestedBy, actor, sourceType, sourceId, overrideReason, locationId}){
  ...
  const mv = postInventoryMovement({type:'Issue', materialId, qty, uom:material.uom, warehouseId, projectId, sourceType:sourceType||'MaterialIssue', sourceId:sourceId||null, valuationRate:rate, actor, locationId:locationId||null});
