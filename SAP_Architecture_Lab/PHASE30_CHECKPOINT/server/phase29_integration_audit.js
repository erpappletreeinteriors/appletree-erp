...
async function main(){
  ...
  // ============================================================
  const siteIssue = await api('purchase1','POST','/api/material-issues',{projectId:PRJ, materialId:'MAT-2', qty:50, warehouseId:'WH-1', purpose:'Site installation — remaining stock'});
